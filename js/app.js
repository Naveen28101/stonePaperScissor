...
function wins(userChoice, computerChoice) {
  // it prints the win starement on the page
  userScore++;
...
function lose(userChoice, computerChoice) {
  ...
  result_p.innerHTML = `${convertToWord(
    userChoice
  )}${smallUserWord} losses to ${convertToWord(
    computerChoice
...
function game(userChoice) {
  ...
  switch (
    userChoice + computerChoice // side by side for comparison
  ) {
    case "rs":
    case "sp":
    case "pr":
